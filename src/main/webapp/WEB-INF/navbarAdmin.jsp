...
<nav class="navbar navbar-expand-lg navbar-light bg-white navbar-bankati py-3">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="<%= ctx %>/home">
            ...
            &nbsp;
            <span class="text-blue fw-bold"><%= application.getAttribute("AppName") %> Administration</span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <ul class="navbar-nav me-3">
                ...
                <li class="nav-item mx-1">
                    <a class="nav-link text-primary" href="<%= ctx %>/home">
                ...
                <li class="nav-item mx-1">
                    <a class="nav-link text-primary" href="<%= ctx %>/users">
                        <i class="bi bi-people-fill me-1"></i> Utilisateurs
                    </a>
                </li>

                <!-- Credits Navigation Item -->
                <li class="nav-item mx-1">
                    <a class="nav-link text-primary" href="<%= ctx %>/credits">
                        <i class="bi bi-clipboard-check me-1"></i> Demandes
                    </a>
                </li>
